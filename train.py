...
train_loader = create_train_loader(create_train_dataset())
valid_loader = create_valid_loader(create_valid_dataset())

print('Train Examples: ',len(train_loader.dataset.all_images))
print('Valid Examples: ',len(valid_loader.dataset.all_images))
